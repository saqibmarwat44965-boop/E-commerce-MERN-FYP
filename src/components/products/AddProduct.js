...
const AddProduct = () => {
    ...
    const defaultValue = {
        ...
        price: "$00",
        img: "",
        productUploader: adminEmail
    }

    useEffect(() => {
        const userRole = localStorage.getItem('role');
        console.log(userRole)
        if (adminEmail !== 'saqibmarwat44965@gmail.com' && userRole !== 'seller') {
    ...
    const validate = () =>
		{
			...
			var regform = document.querySelector('.addproductform');
    ...
    return(
        ...
        <div className='addproduct-form addproductform'>
            ...
            <form encType='multipart/form-data'>
                ...
                <input onChange={(e) => onValueChange(e)} name='productname' className='addproduct-fields-text'/>
                <br/>
                ...
                <input onChange={(e) => onValueChange(e)} name='category' className='addproduct-fields-text'/>
                <br/>
                
                <label htmlFor='status' className='addproduct-fields-discription'>status*</label>
                <span className='addproduct-message-status'></span>
                <input onChange={(e) => onValueChange(e)} name='status' className='addproduct-fields-text'/>
                <br/>
                ...
                <input onChange={(e) => onValueChange(e)} name='materials' className='addproduct-fields-text'/>
                <br/>

                <label htmlFor='style' className='addproduct-fields-discription'>style*</label>
                <span className='addproduct-message-style'></span>
                <input onChange={(e) => onValueChange(e)} name='style' className='addproduct-fields-text'/>
                <br/>
                
                <label htmlFor='price' className='addproduct-fields-discription'>price*</label>
                <span className='addproduct-message-price'></span>
                <input onChange={(e) => onValueChange(e)} name='price' className='addproduct-fields-text'/>
                <br/>

                <label htmlFor='img' className='addproduct-fields-discription'>img*</label>
                <span className='addproduct-message-price'></span>
                <input onChange={(e) => handleFileChange(e)} name='img' type="file" className='addproduct-fields-text'/>
                <br/>

                <input type='hidden' value={adminEmail} name="productUploader"/>
                
                <input type='button' onClick={addProductDetails} value='Add Product' className='addproduct-button'/>
            </form>
        </div>
